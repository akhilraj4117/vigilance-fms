...
class ComplaintDetails(db.Model):
    ...
    plaintiff_designation = db.Column(db.String(200))
    plaintiff_institution = db.Column(db.String(200))
    ...
    respondent_designation = db.Column(db.String(200))
    respondent_institution = db.Column(db.String(200))
